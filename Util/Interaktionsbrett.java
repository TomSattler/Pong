package Util;/* Eine schrecklich verschachtelte Klasse zur einfachen Darstellung
 ...
 * Util.Interaktionsbrett &uuml;bergeben, k&ouml;nnen mit der
 ...
 * vom Util.Interaktionsbrett bei einer Mausaktion aufgerufen
 * werden.
 * <ul>
 * <li>
 ...
 * </ul>
 * 
 * Objekte k&ouml;nnen dem Util.Interaktionsbrett mitteilen, dass
...
public class Interaktionsbrett {
  ...
  private static int interaktionsBrettHoehe = 700;
  private static int interaktionsBrettBreite = 800;
  private JFrame rahmen = new JFrame("Util.Interaktionsbrett");
  //private static final long serialVersionUID = 1L;
  private static final Dimension DIM = new Dimension(interaktionsBrettBreite,
      interaktionsBrettHoehe);
  ...
  public Interaktionsbrett() {
    ...
    javax.swing.SwingUtilities.invokeLater(new Runnable() {
      // @Override
      public void run() {
        rahmen = new JFrame("Util.Interaktionsbrett");
        rahmen.add(brett);
  ...
  public int getHoehe(){
    return interaktionsBrettHoehe;
  }

  public int getBreite(){
    return interaktionsBrettBreite;
  }
  /**
   ...
   * der Klasse Util.Interaktionsbrett </a> gezeigt wird.
   * 
   * @param quelle
   ...
   * Util.Interaktionsbrett </a> gezeigt wird.
   * 
   * @param quelle
   *          Objekt, das informiert werden soll, falls
   ...
   * werden, wie es in der <a href="#Nutzung"> Beschreibung
   * der Klasse Util.Interaktionsbrett </a> gezeigt wird. Der als
  ...
  /**
   * Objekte k&ouml;nnen an ein Util.Interaktionsbrett so
   ...
   *          wenn im Util.Interaktionsbrett eine Taste
   *          gedr&uuml;ckt wurde
   */
